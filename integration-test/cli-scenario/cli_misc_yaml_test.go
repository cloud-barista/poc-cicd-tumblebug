...
name: ns-unit-01`,
		...
		tc = TestCases{
			...
			CmdArgs: []string{"namespace", "list-id", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml"},
...
id: mock-unit-config01-dev`,
		...
		tc = TestCases{
			...
			CmdArgs:             []string{"image", "fetch", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--cc", "mock-unit-config01", "--ns", "ns-unit-01"},
...
id: mock-unit-config01-dev`,
		...
		tc = TestCases{
			...
			CmdArgs:             []string{"spec", "fetch", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--cc", "mock-unit-config01", "--ns", "ns-unit-01"},
...
name: mock-unit-config01-dev`,
		...
		tc = TestCases{
			Name:    "get mcis vm",
			CmdArgs: []string{"mcis", "get-vm", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--vm", "mock-unit-config01-dev-01"},
...
name: mock-unit-config01-dev-01`,
		...
		tc = TestCases{
			...
			CmdArgs: []string{"mcis", "status-vm", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--vm", "mock-unit-config01-dev-01"},
			ExpectResStartsWith: `id: mock-unit-config01-dev-01
name: mock-unit-config01-dev-01`,
		}
		TumblebugCmdTest(t, tc)
		...
		tc = TestCases{
			...
			CmdArgs:             []string{"mcis", "suspend-vm", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--vm", "mock-unit-config01-dev-01"},
		...
		tc = TestCases{
			Name:                "resume mcis vm",
			CmdArgs:             []string{"mcis", "resume-vm", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--vm", "mock-unit-config01-dev-01"},
		...
		tc = TestCases{
			Name:                "reboot mcis vm",
			CmdArgs:             []string{"mcis", "reboot-vm", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--vm", "mock-unit-config01-dev-01"},
		...
		tc = TestCases{
			Name:    "all benchmark",
			CmdArgs: []string{"mcis", "benchmark", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--host", "localhost"},
			ExpectResStartsWith: `resultarray:
- result: "1.0"`,
		}
		TumblebugCmdTest(t, tc)
		...
		tc = TestCases{
			Name:    "benchmark",
			CmdArgs: []string{"mcis", "benchmark", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--host", "localhost", "--action", "cpus"},
			ExpectResStartsWith: `resultarray:
- result: "1.0"`,
		}
		TumblebugCmdTest(t, tc)
		...
		tc = TestCases{
			...
			CmdArgs:             []string{"mcis", "terminate-vm", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--vm", "mock-unit-config01-dev-01"},
		...
		tc = TestCases{
			Name:                "delete mcis vm",
			CmdArgs:             []string{"mcis", "del-vm", "--config", "../conf/grpc_conf.yaml", "-i", "yaml", "-o", "yaml", "--ns", "ns-unit-01", "--mcis", "mock-unit-config01-dev", "--vm", "mock-unit-config01-dev-01"},
