...
go get -v github.com/cloud-barista/poc-cicd-tumblebug 

# Set cb-tumblebug configuration
echo  'source $GOPATH/src/github.com/cloud-barista/poc-cicd-tumblebug/conf/setup.env' >> ~/.bashrc 
source $GOPATH/src/github.com/cloud-barista/poc-cicd-tumblebug/conf/setup.env

# Set cb-tumblebug environment for go module
export GO111MODULE=on

# Build tumblebug
cd ~/go/src/github.com/cloud-barista/poc-cicd-tumblebug/src/
make
