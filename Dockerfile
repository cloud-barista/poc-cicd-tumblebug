...
ADD . /go/src/github.com/cloud-barista/poc-cicd-tumblebug

WORKDIR /go/src/github.com/cloud-barista/poc-cicd-tumblebug
...
COPY --from=builder /go/src/github.com/cloud-barista/poc-cicd-tumblebug/assets/ /app/assets/

COPY --from=builder /go/src/github.com/cloud-barista/poc-cicd-tumblebug/conf/ /app/conf/

COPY --from=builder /go/src/github.com/cloud-barista/poc-cicd-tumblebug/src/cb-tumblebug /app/src/
